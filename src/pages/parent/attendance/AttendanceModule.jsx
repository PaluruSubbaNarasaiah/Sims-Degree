...
const AttendanceModule = () => {
    // Mock data for students in degree college
    ...
    // Sample data - College attendance with lectures and practical sessions
    const [allAttendanceDataByStudent] = useState({
        'student1': [
            // Alex Johnson's Attendance (May, June, July 2025) - B.Sc CS
            ...
            { date: '2025-05-09', status: 'half-day', reason: 'Lab session only', checkOut: '12:00' },
            ...
            { date: '2025-06-20', status: 'half-day', reason: 'Morning lectures only', checkOut: '12:00' },
        ...
        'student2': [
            // Emily Johnson's Attendance (May, June, July 2025) - B.Com

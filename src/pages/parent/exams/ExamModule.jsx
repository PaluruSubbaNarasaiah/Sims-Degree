...
const ExamModule = () => {
    ...
    const [allStudentExamData] = useState({
        'student1': { // Alex Johnson's data - B.Sc CS
            marks: {
                'Data Structures': 78,
            ...
            subjectsConfig: {
                ...
                'Database Management': { maxMarks: 100, passingMarks: 40 },
                'Programming in Java': { maxMarks: 100, passingMarks: 40 },
                'Computer Networks': { maxMarks: 100, passingMarks: 40 },
                'Software Engineering': { maxMarks: 100, passingMarks: 40 },
            },
        },
        'student2': { // Emily Johnson's data - B.Com
            marks: {
            ...
            subjectsConfig: {
                ...
                'Business Statistics': { maxMarks: 100, passingMarks: 40 },
                'Economics': { maxMarks: 100, passingMarks: 40 },
                'Business Law': { maxMarks: 100, passingMarks: 40 },
                'Cost Accounting': { maxMarks: 100, passingMarks: 40 },
            },
        }
    });
    // --- End Sample Data ---
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg flex flex-col md:flex-row items-start md:items-center gap-4 mb-8 border border-blue-200 ">
                            ...
                            <div>
                                ...
                                <p className="text-md text-blue-700">
                                    ...
                                    Course: <span className="font-semibold">{loggedInStudent.course}</span> |
                                    Semester: <span className="font-semibold">{loggedInStudent.semester}</span>
                                </p>

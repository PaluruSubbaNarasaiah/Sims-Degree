    ...
    const rawEvents = [
      {
        ...
        description: 'Discussion regarding student academic progress.',
        eventType: ['Meeting'],
        startDate: '2025-08-01',
        endDate: null,
        eventName: 'Parent-lecturer Meeting',
        targetAudience: 'Parents, lecturers',
      },
      {
        id: 'evt004',
        title: 'Annual College Cultural Fest',
        description: 'A celebration of diverse cultures with student performances and exhibitions.',
        eventType: ['Cultural'],
      ...
      {
        id: 'evt005',
        title: 'Degree Convocation Ceremony',
        description: 'Celebrating the achievements of the graduating degree students.',
        eventType: ['Academic'],
      ...
      },
      {
        ...
        description: 'Quarterly meeting of the college board members.',
        eventType: ['Meeting'],
        status: 'cancelled',
                  ...
                  <td colSpan="6" className="px-6 py-8 text-center">
                    <div className="flex flex-col items-center justify-center text-gray-500">
                      ...
                      <h3 className='text-lg font-semibold mb-1'>
                        {events.length === 0 ? 'No college events available' : 'No matching college events found.'}
                      </h3>
                      <p className='mt-1 text-sm text-gray-600'>
                        {events.length === 0 ? 'There are currently no college events to display' :

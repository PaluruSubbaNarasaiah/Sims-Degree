...
const FeeModule = () => {
    ...
    const [allStudentFeeData, setAllStudentFeeData] = useState({
        'child1': [
            { term: '1st Semester', feeType: 'Tuition Fee', amount: 25000, dueDate: '2023-06-15', status: 'Due' },
            { term: '2nd Semester', feeType: 'Lab Fee', amount: 15000, dueDate: '2023-09-15', status: 'Due' },
            { term: '3rd Semester', feeType: 'Library & Development Fee', amount: 8000, dueDate: '2023-12-15', status: 'Due' }
        ],
        'child2': [
            { term: '1st Semester', feeType: 'Tuition Fee', amount: 22000, dueDate: '2023-07-01', status: 'Due' },
            { term: '2nd Semester', feeType: 'Practical Fee', amount: 12000, dueDate: '2023-10-01', status: 'Due' }, // Changed from Paid to Due for consistency in initial state
            { term: '3rd Semester', feeType: 'Examination Fee', amount: 5000, dueDate: '2024-01-01', status: 'Due' }
        ]
    });
                            ...
                            {showReceipt && paymentSuccess && transactionIdSubmitted && transactionId && invoiceId && (
                                <div ref={receiptRef} className="mt-6 p-6 bg-white border border-gray-300 rounded-xl shadow-lg font-sans">
                                    ...
                                    <div className="flex flex-col items-center justify-center border-b pb-4 mb-4">
                                        <div className="text-3xl font-extrabold text-indigo-700 mb-2">College Name</div>
                                        <p className="text-sm text-gray-600 mb-1">123 College Lane, Education City, 560001</p>
                                        <p className="text-sm text-gray-600">contact@collegename.edu | +91-9876543210</p>
                                    </div>

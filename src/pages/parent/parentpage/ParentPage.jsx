    ...
    children: [
      {
        ...
        performance: [
          { subject: 'Data Structures', score: 88, average: 75 },
          { subject: 'Computer Networks', score: 92, average: 78 },
        ...
        examResults: [
          { id: 1, subject: "Data Structures", type: "Mid-Semester Exam", score: 79, maxScore: 100, date: "May 1, 2025", icon: <FaClipboardCheck /> },
          { id: 2, subject: "Computer Networks", type: "Internal Assessment", score: 70, maxScore: 100, date: "April 28, 2025", icon: <FaExclamationTriangle className="text-warning" /> },
          { id: 3, subject: "Database Systems", type: "Mid-Semester Exam", score: 88, maxScore: 100, date: "April 15, 2025", icon: <FaClipboardCheck /> },
          { id: 4, subject: "Software Engineering", type: "Project Evaluation", score: 75, maxScore: 100, date: "March 20, 2025", icon: <FaClipboardCheck /> },
          { id: 5, subject: "Operating Systems", type: "End-Semester Exam", score: 91, maxScore: 100, date: "Jan 10, 2025", icon: <FaAward className="text-info" /> },
          { id: 6, subject: "Web Technologies", type: "Practical Exam", score: 82, maxScore: 100, date: "Dec 5, 2024", icon: <FaClipboardCheck /> }
        ]
      },
      {
        id: 2,
        ...
        performance: [
          { subject: 'Business Studies', score: 85, average: 80 },
          { subject: 'Economics', score: 78, average: 72 },
          { subject: 'Accounting', score: 90, average: 85 } // Added a third subject
        ],
        events: [
          { id: 2, title: "Business Plan Competition", date: "July 20, 2023", time: "10:00 AM" },
          { id: 3, title: "Annual Cultural Fest", date: "July 25, 2023", time: "9:00 AM" }
        ],
        payments: [
        ...
        examResults: [
          { id: 1, subject: "Business Mathematics", type: "Mid-Semester Exam", score: 72, maxScore: 100, date: "April 10, 2025", icon: <FaClipboardCheck /> },
          { id: 2, subject: "Economics", type: "Internal Assessment", score: 80, maxScore: 100, date: "April 5, 2025", icon: <FaClipboardCheck /> },
          { id: 3, subject: "Marketing Management", type: "Case Study Project", score: 95, maxScore: 100, date: "March 28, 2025", icon: <FaAward className="text-info" /> }
        ]
      }
    ]
  };
                ...
                >
                  <Card.Body className="d-flex align-items-center p-3">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <small className="text-muted d-block">{child.course} {child.rollNumber && `• Roll No: ${child.rollNumber}`}</small>
                      {child.college && <small className="text-muted">{child.college}</small>}
                    </div>
            ...
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="mb-0 text-dark-emphasis">
                  {selectedChild.course}
                  {selectedChild.rollNumber && ` • Roll No: ${selectedChild.rollNumber}`}
                  {selectedChild.college && ` • ${selectedChild.college}`}
                </p>
              </div>
            </div>
            <Button
            ...
            <Card.Body className="d-flex flex-column p-4">
              ...
              <div className="d-grid gap-3">
                ...
                <Button
                  ...
                  onClick={handlePayFees} // Updated to navigate to /fees
                >
                  <FaRupeeSign className="me-3" size={20} /> Pay College Fees
                </Button>
                <Button

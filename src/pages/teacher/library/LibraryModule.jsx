  ...
  const [allResources, setAllResources] = useState([
    {
      ...
      classes: ['B.Sc Mathematics', 'B.Sc Computer Science'],
    ...
    },
    {
      ...
      subject: 'Biology',
      topic: 'Cell Biology',
      classes: ['B.Sc Biology', 'B.Sc Chemistry'],
    ...
    },
    {
      ...
      classes: ['B.Sc Computer Science', 'B.Sc Physics', 'B.Com', 'M.A English'],
    ...
    },
    {
      ...
      classes: ['B.A History', 'M.A History'],
    ...
    },
    {
      ...
      subject: 'Mathematics',
      topic: 'Calculus',
      classes: ['B.Sc Mathematics', 'B.Sc Physics'],

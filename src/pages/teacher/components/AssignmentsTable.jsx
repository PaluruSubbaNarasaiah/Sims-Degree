...
const AssignmentsTable = () => {
  // Sample data
  const assignments = [
    { id: 1, assignment: "Linear Algebra: Matrix Operations", class: "B.Sc Mathematics", dueDate: "2023-10-15", status: "Pending" },
    { id: 2, assignment: "Cell Biology: Research Project", class: "B.Sc Chemistry", dueDate: "2023-10-20", status: "Completed" },
    { id: 3, assignment: "Modern History: Essay Assignment", class: "B.A History", dueDate: "2023-10-25", status: "Late" },
    { id: 4, assignment: "Academic Writing: Literary Analysis", class: "M.A English", dueDate: "2023-10-18", status: "Completed" },
    { id: 5, assignment: "Quantum Mechanics: Lab Report", class: "B.Sc Physics", dueDate: "2023-10-22", status: "Pending" },
    { id: 6, assignment: "Organic Chemistry: Quiz", class: "B.Sc Chemistry", dueDate: "2023-10-30", status: "Pending" },
    { id: 7, assignment: "Business Economics: Case Study", class: "B.Com", dueDate: "2023-11-05", status: "Pending" },
    { id: 8, assignment: "Applied Statistics: Data Analysis", class: "B.Sc Statistics", dueDate: "2023-11-10", status: "Completed" },
  ];

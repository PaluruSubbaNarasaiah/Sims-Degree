...
import ExamScheduleViewTeacher from './ExamScheduleViewTeacher'; // Modified for teacher panel
...
const SchedulesModule = () => {
  // Define tabs for the teacher panel
  ...
  // Mock Teacher ID (replace with actual teacher ID from context/auth in a real app)
  const currentTeacherId = "teacher_T123";

  // In-memory state for teacher's own regular schedules
  const [teacherRegularSchedules, setTeacherRegularSchedules] = useState([
    // Mock Data for demonstration
    { id: 'trs1', teacherId: 'teacher_T123', dayOfWeek: 'Monday', startTime: '09:00', endTime: '09:45', subject: 'Linear Algebra', classId: 'B.Sc Mathematics - Sem 1' },
    { id: 'trs2', teacherId: 'teacher_T123', dayOfWeek: 'Monday', startTime: '10:00', endTime: '10:45', subject: 'Organic Chemistry', classId: 'B.Sc Chemistry - Sem 2' },
    { id: 'trs3', teacherId: 'teacher_T123', dayOfWeek: 'Tuesday', startTime: '11:00', endTime: '11:45', subject: 'Academic Writing', classId: 'M.A English - Sem 1' },
    { id: 'trs4', teacherId: 'teacher_T124', dayOfWeek: 'Wednesday', startTime: '09:00', endTime: '09:45', subject: 'Quantum Mechanics', classId: 'B.Sc Physics - Sem 3' }, // Another teacher's schedule
  ]);

  // In-memory state for exam schedules (read-only for teachers, comes from Admin)
  const [adminExamSchedules, setAdminExamSchedules] = useState([
    ...
    { id: 'adm_exam1', classId: 'B.Sc Mathematics - Sem 1', examType: 'Formative Assessment 1', date: '2025-07-10', time: '09:00', subject: 'Linear Algebra' },
    { id: 'adm_exam2', classId: 'M.A English - Sem 1', examType: 'Formative Assessment 2', date: '2025-07-15', time: '11:00', subject: 'Academic Writing' },
    { id: 'adm_exam3', classId: 'B.Sc Chemistry - Sem 2', examType: 'Summative Assessment 1', date: '2025-07-20', time: '10:30', subject: 'Organic Chemistry' },
    { id: 'adm_exam4', classId: 'B.A History - Sem 2', examType: 'Formative Assessment 3', date: '2025-07-25', time: '14:00', subject: 'Modern History' },
    { id: 'adm_exam5', classId: 'B.Com - Sem 1', examType: 'Summative Assessment 2', date: '2025-08-01', time: '09:00', subject: 'Business Economics' },
  ]);
  ...
  const handleSaveRegularSchedule = (scheduleData) => {
    if (editingRegularSchedule) {
      ...
      setTeacherRegularSchedules(prevSchedules =>
      ...
      const newSchedule = {
        ...
        teacherId: currentTeacherId, // Assign to the current teacher
      };
      setTeacherRegularSchedules(prevSchedules => [...prevSchedules, newSchedule]);
    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
      ...
      <div className="bg-white rounded-lg shadow p-6 min-h-[400px]">
        {activeTab === "Regular Schedule" && (
          <RegularScheduleView
            teacherRegularSchedules={teacherRegularSchedules.filter(s => s.teacherId === currentTeacherId)} // Filter for current teacher
      ...
      {showCreateRegularScheduleModal && (
        <CreateRegularScheduleModal
          ...
          classTabs={['B.Sc Computer Science - Sem 1', 'B.Sc Physics - Sem 2', 'B.Sc Chemistry - Sem 1', 'B.Sc Mathematics - Sem 1', 'B.Com - Sem 1', 'M.A English - Sem 1', 'B.A History - Sem 2']} // Pass degree program options
        />
      )}
    </div>
  );

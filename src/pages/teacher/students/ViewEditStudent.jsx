...
const CLASS_OPTIONS = [
  ...
  { label: 'B.Sc Statistics', value: 'B.Sc Statistics' },
  { label: 'B.Com', value: 'B.Com' },
  { label: 'M.A English', value: 'M.A English' },
  { label: 'B.A History', value: 'B.A History' },
];
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select options={CLASS_OPTIONS} value={getSelectValue(CLASS_OPTIONS, formData.class)} onChange={(selected) => handleSelectChange('class', selected)} placeholder="Select Program"

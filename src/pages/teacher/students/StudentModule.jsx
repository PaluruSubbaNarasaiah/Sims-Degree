...
const MOCK_STUDENTS = [
  {
    id: 's1',
    admissionNo: '2023CSC001', // New Admission No
    studentId: 'STU-1001', // Student ID
    password: 'securepassword1', // Added password for mock data
    name: 'Alice Smith',
    rollNumber: 'R001',
    section: 'A',
    class: 'B.Sc Computer Science',
    parent: 'Parent A',
    status: 'active', // Status field is retained in mock data, but not displayed/filtered as per request
    avatar: 'https://via.placeholder.com/150/0000FF/FFFFFF?text=AS',
    address: '123 Main St',
    gender: 'Female',
  ...
  {
    id: 's2',
    admissionNo: '2023PHY002',
    studentId: 'STU-1002',
    password: 'securepassword2', // Added password for mock data
    name: 'Bob Johnson',
    rollNumber: 'R002',
    section: 'B',
    class: 'B.Sc Physics',
    parent: 'Parent B',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/FF0000/FFFFFF?text=BJ',
    address: '456 Oak Ave',
    gender: 'Male',
    dateOfBirth: '2009-03-20',
    studentType: 'Migrated Student',
    previousSchoolName: 'Old School A',
    previousSchoolAddress: '789 Pine Ln',
    previousSchoolPhoneNumber: '111-222-3333',
    previousSchoolStartDate: '2022-09-01',
    previousSchoolEndDate: '2024-03-30',
    documents: [{ name: 'Transfer Certificate', url: 'http://example.com/doc1.pdf' }],
  },
  {
    id: 's3',
    admissionNo: '2023CHE003',
    studentId: 'STU-1003',
    password: 'securepassword3', // Added password for mock data
    name: 'Charlie Brown',
    rollNumber: 'R003',
    section: 'A',
    ...
    parent: 'Parent C',
    status: 'inactive',
    avatar: 'https://via.placeholder.com/150/008000/FFFFFF?text=CB',
    address: '789 Elm Rd',
    gender: 'Male',
  ...
  {
    id: 's4',
    admissionNo: '2023MAT004',
    studentId: 'STU-1004',
    password: 'securepassword4', // Added password for mock data
    name: 'Diana Prince',
    rollNumber: 'R004',
    section: 'C',
    ...
    parent: 'Parent D',
    status: 'graduated',
    avatar: 'https://via.placeholder.com/150/FFFF00/000000?text=DP',
  ...
  {
    id: 's5',
    admissionNo: '2023COM005',
    studentId: 'STU-1005',
    password: 'securepassword5', // Added password for mock data
    name: 'Eve Adams',
    rollNumber: 'R005',
    section: 'B',
    class: 'B.Com',
    parent: 'Parent E',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/800080/FFFFFF?text=EA',
    address: '222 Birch Ct',
    gender: 'Female',
    dateOfBirth: '2009-07-01',
    studentType: 'Migrated Student',
    previousSchoolName: 'Another School Z',
    previousSchoolAddress: '333 Willow Dr',
    previousSchoolPhoneNumber: '999-888-7777',
    previousSchoolStartDate: '2023-01-15',
    previousSchoolEndDate: '2024-06-01',
...
const StudentModule = () => {
  ...
  const classes = ['B.Sc Computer Science', 'B.Sc Physics', 'B.Sc Chemistry', 'B.Sc Mathematics', 'B.Sc Statistics', 'B.Com', 'M.A English', 'B.A History']; // Updated to degree programs
  const classOptions = [{ value: 'all', label: 'All Programs' }, ...classes.map(cls => ({ value: cls, label: cls }))];

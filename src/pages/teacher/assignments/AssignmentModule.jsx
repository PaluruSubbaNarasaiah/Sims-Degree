    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {/* Class */}
          <div>
            <label htmlFor="edit-class" className="block text-sm font-medium text-gray-700 mb-1">Course <span className="text-red-500">*</span></label>
            <select
              id="edit-class"
              name="class"
...
const AssignmentModule = () => {
  // Sample data with course-wise assignments
  const initialAssignmentsData = [
    { id: 5, title: "Quantum Mechanics Assignment", class: "B.Sc Physics", section: "A", subject: "Physics", dueDate: "2025-07-20", description: "Solve advanced problems on wave-particle duality and quantum states." },
    { id: 6, title: "Data Structures Project", class: "B.Tech CSE", section: "B", subject: "Computer Science", dueDate: "2025-07-22", description: "Implement binary search trees and hash tables with full documentation." },
    { id: 7, title: "Calculus Integration", class: "B.Sc Mathematics", section: "A", subject: "Mathematics", dueDate: "2025-07-25", description: "Complete integration problems using substitution and parts methods." },
    { id: 8, title: "Market Analysis Report", class: "B.Com", section: "C", subject: "Economics", dueDate: "2025-07-18", description: "Analyze supply and demand trends in the current market scenario." },
    { id: 9, title: "Research Methodology Project", class: "M.A English", section: "A", subject: "Research Methods", dueDate: "2025-08-01", description: "Conduct literature review and prepare research proposal on contemporary literary themes." },
  ];

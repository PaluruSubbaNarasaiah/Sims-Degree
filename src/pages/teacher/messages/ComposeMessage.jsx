...
// Predefined recipient groups for a faculty panel
const recipientOptions = [
  ...
  { value: 'bsc-computer-science', label: 'B.Sc Computer Science Students' },
  { value: 'bsc-physics', label: 'B.Sc Physics Students' },
  { value: 'bsc-chemistry', label: 'B.Sc Chemistry Students' },
  { value: 'bsc-mathematics', label: 'B.Sc Mathematics Students' },
  { value: 'bcom', label: 'B.Com Students' },
  { value: 'ma-english', label: 'M.A English Students' },
  { value: 'ba-history', label: 'B.A History Students' },
];

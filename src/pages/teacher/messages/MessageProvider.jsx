...
export const MessageProvider = ({ children }) => {
  const [messages, setMessages] = useState([
    ...
    // Ensure you keep this data consistent with MessageModule's initial state
    {
      ...
      content: 'This is a reminder about the upcoming parent-faculty meeting scheduled for Friday, June 10th at 3:00 PM in the college auditorium. We will discuss student progress and upcoming semester activities.',
    ...
    },
    {
        ...
        recipients: ['faculty@college.edu'],
        status: 'sent',
  ...
  const unreadMessageCount = messages.filter(m =>
    ...
    m.sender !== 'faculty@college.edu' && // Not sent by the current user (faculty)

...
const DiaryModule = () => {
    ...
    const [homeworkEntries, setHomeworkEntries] = useState([
        ...
        {
            id: 'hw3',
            lecturerId: 'lecturer_F123', // Changed to currentlecturerId for demonstration
            date: '2025-06-26',
    ...
    const [personalNotes, setPersonalNotes] = useState([
        { id: 'pn1', lecturerId: 'lecturer_F123', date: '2025-06-27', title: 'lecturer Meeting Notes', content: 'Discussed new assessment criteria. Follow up with department head regarding B.Sc Computer Science curriculum updates.' },
        { id: 'pn2', lecturerId: 'lecturer_F123', date: '2025-06-26', title: 'To-Do List', content: '1. Prepare lecture slides for Data Structures class. 2. Email students about project deadlines. 3. Grade programming assignments.' },
        { id: 'pn3', lecturerId: 'lecturer_F124', date: '2025-06-27', title: 'Research Ideas', content: 'Explore machine learning applications for final year projects.' },
    ]);

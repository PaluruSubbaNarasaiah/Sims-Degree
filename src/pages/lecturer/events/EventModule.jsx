    ...
    const rawEvents = [
      {
        ...
        description: 'Discussion regarding student academic progress and career guidance.',
        eventType: ['Meeting'],
      ...
      },
      {
        ...
        description: 'Inter-departmental cultural competition featuring dance, music, drama and literary events.',
        eventType: ['Cultural'],
        startDate: '2025-06-20',
        endDate: '2025-06-22',
        eventName: 'Spectrum 2025',
        targetAudience: 'All',
      },
      {
        id: 'evt005',
        title: 'Convocation Ceremony',
        description: 'Degree conferment ceremony for B.Sc, B.Com and M.A graduates.',
        eventType: ['Academic'],
        startDate: '2024-11-10',
        endDate: '2024-11-10',
        eventName: 'Annual Convocation',
        targetAudience: 'Students, Parents, Staff',
      },
      {
        id: 'evt006',
        title: 'College Academic Council Meeting',
        description: 'Quarterly meeting of academic council members to review curriculum and policies.',
        eventType: ['Meeting'],
        status: 'cancelled',
        startDate: '2025-09-05',
        endDate: '2025-09-05',
        eventName: 'Academic Council Q3',
        targetAudience: 'lecturer, Staff',
      }
    ];

...
const SchedulesModule = () => {
  ...
  const [lecturerRegularSchedules, setlecturerRegularSchedules] = useState([
    ...
    { id: 'trs1', lecturerId: 'lecturer_T123', dayOfWeek: 'Monday', startTime: '09:00', endTime: '09:45', subject: 'Linear Algebra', classId: 'B.Sc Mathematics - Sem 1' },
    { id: 'trs2', lecturerId: 'lecturer_T123', dayOfWeek: 'Monday', startTime: '10:00', endTime: '10:45', subject: 'Organic Chemistry', classId: 'B.Sc Chemistry - Sem 2' },
    { id: 'trs3', lecturerId: 'lecturer_T123', dayOfWeek: 'Tuesday', startTime: '11:00', endTime: '11:45', subject: 'Academic Writing', classId: 'M.A English - Sem 1' },
    { id: 'trs4', lecturerId: 'lecturer_T124', dayOfWeek: 'Wednesday', startTime: '09:00', endTime: '09:45', subject: 'Quantum Mechanics', classId: 'B.Sc Physics - Sem 3' }, // Another lecturer's schedule
  ]);

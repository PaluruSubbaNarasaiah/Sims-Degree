...
const ViewSubmissions = ({ onBackToAssignmentModule, selectedClassFilter, allAvailableClasses }) => {
  ...
  const [mockAllSubmissions, setMockAllSubmissions] = useState([
    { submissionId: 101, assignmentTitle: "Database Design Project", class: "B.Tech CSE", section: "A", subject: "Database Systems", studentName: "John Doe", submittedDate: "2025-11-09", status: "Graded", grade: "A", feedback: "Excellent normalization and ER design.", file: { name: "john_doe_database.pdf", content: "PDF content for Database Design Project by John Doe." } },
    { submissionId: 102, assignmentTitle: "Quantum Mechanics Assignment", class: "B.Sc Physics", section: "A", subject: "Physics", studentName: "Jane Smith", submittedDate: "2025-11-10", status: "Pending", grade: "-", feedback: "", file: { name: "jane_smith_quantum.docx", content: "DOCX content for Quantum Mechanics by Jane Smith." } },
    { submissionId: 103, assignmentTitle: "Organic Chemistry Lab Report", class: "B.Sc Chemistry", section: "B", subject: "Chemistry", studentName: "Alice Johnson", submittedDate: "2025-11-14", status: "Graded", grade: "B+", feedback: "Good synthesis procedure, review spectral analysis.", file: { name: "alice_organic_lab.pdf", content: "PDF content for Organic Chemistry Lab by Alice Johnson." } },
    { submissionId: 104, assignmentTitle: "Market Research Analysis", class: "B.Com", section: "C", subject: "Marketing", studentName: "Bob Williams", submittedDate: "2025-11-04", status: "Late", grade: "C", feedback: "Submitted late. Analysis needs more depth.", file: { name: "bob_market_research.docx", content: "DOCX content for Market Research by Bob Williams." } },
    { submissionId: 105, assignmentTitle: "Literary Criticism Essay", class: "M.A English", section: "A", subject: "Literature", studentName: "Eva Green", submittedDate: "2025-11-19", status: "Pending", grade: "-", feedback: "", file: { name: "eva_literary_criticism.pdf", content: "PDF content for Literary Criticism by Eva Green." } },
    { submissionId: 106, assignmentTitle: "Statistical Analysis Project", class: "B.Sc Statistics", section: "A", subject: "Statistics", studentName: "David Lee", submittedDate: "2025-11-08", status: "Graded", grade: "B", feedback: "Good methodology, minor errors in interpretation.", file: { name: "david_statistics.pdf", content: "PDF content for Statistical Analysis by David Lee." } },
    { submissionId: 107, assignmentTitle: "Financial Accounting Case Study", class: "B.Com", section: "B", subject: "Accounting", studentName: "Frank White", submittedDate: "2025-11-13", status: "Pending", grade: "-", feedback: "", file: { name: "frank_accounting.zip", content: "ZIP content for Accounting Case Study by Frank White." } },
  ]);
  ...
  const availableClasses = allAvailableClasses || ["All", "B.Tech CSE", "B.Sc Physics", "B.Sc Chemistry", "B.Com", "M.A English"];
  ...
  return (
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          <label htmlFor="classFilter" className="block text-sm font-medium text-gray-700 mb-1">Filter by Program:</label>
          <div className="relative">
            <select
              id="classFilter"
              value={filterClass}
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p><strong>Program:</strong> {selectedSubmission.class}</p>

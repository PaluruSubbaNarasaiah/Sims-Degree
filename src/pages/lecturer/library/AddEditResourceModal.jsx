...
const AddEditResourceModal = ({ initialData, onClose, onSave }) => { // Removed classOptions prop
  ...
  // Generate class options for degree programs
  const classOptions = [
    ...
    { value: 'B.Sc Statistics', label: 'B.Sc Statistics' },
    { value: 'B.Sc Biology', label: 'B.Sc Biology' },
    { value: 'B.Com', label: 'B.Com' },
    { value: 'B.A History', label: 'B.A History' },
    { value: 'M.A English', label: 'M.A English' },
    { value: 'M.A History', label: 'M.A History' }
  ];
    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto flex-grow">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Useful to Programs</label>
            <Select
              isMulti

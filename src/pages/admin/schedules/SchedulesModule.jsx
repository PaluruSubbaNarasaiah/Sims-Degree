...
const SchedulesModule = () => {
  ...
  const [allSchedules, setAllSchedules] = useState([
    ...
    },
    {
      id: 'mock2',
      program: 'B.Sc. Computer Science',
      examType: 'Formative Assessment 1', // Same exam, different course
      date: '2025-07-15',
      time: '11:00',
    ...
    },
    {
      id: 'mock4',
      program: 'B.Com',
      examType: 'Summative Assessment 1', // Same exam, different course
      date: '2025-07-25',
      time: '14:00',
      course: 'Business Law',
    },
    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
        ...
        {showCreateScheduleModal && (
          <CreateScheduleModal
            ...
            programTabs={programTabs} // Pass the list of program tabs for the dropdown in the modal
          />
        )}
      </div>
  );

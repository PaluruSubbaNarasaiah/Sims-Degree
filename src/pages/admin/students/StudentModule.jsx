...
const MOCK_STUDENTS = [
  {
    ...
    status: 'active',
    avatar: 'https://via.placeholder.com/150/0066CC/FFFFFF?text=AS',
  ...
  },
  {
    ...
    parent: 'Vinod Kumar',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/4ECDC4/FFFFFF?text=RK',
    address: '789 Residency Road, Bangalore, Karnataka 560025',
    gender: 'Male',
    dateOfBirth: '2003-01-10',
    studentType: 'Migrated Student',
    previousSchoolName: 'St. Joseph College',
    previousSchoolAddress: '36 Lalbagh Road, Bangalore, Karnataka 560027',
    ...
    documents: [
      ...
      { name: 'Migration Certificate.pdf', url: 'http://example.com/docs/mc_rahul.pdf' }
    ],
  },
  {
    id: 's4',
    admissionNo: 'ADM-2024-004',
    studentId: 'ENG2024004',
    password: 'student123',
    name: 'Sneha Reddy',
    rollNumber: 'ART24004',
    program: 'Arts',
    ...
    parent: 'Ramesh Reddy',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/FFE66D/000000?text=SR',
  ...
  },
  {
    ...
    status: 'active',
    avatar: 'https://via.placeholder.com/150/A8E6CF/000000?text=VS',
  ...
  },
  {
    ...
    status: 'active',
    avatar: 'https://via.placeholder.com/150/FF8B94/FFFFFF?text=AI',
  ...
  },
  {
    ...
    studentType: 'Migrated Student',
    previousSchoolName: 'Christ College',
    previousSchoolAddress: 'Hosur Road, Bangalore, Karnataka 560029',
  ...
  },
  {
    ...
    parent: 'Ashok Gupta',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/FFEAA7/000000?text=MG',
  ...
  },
  {
    ...
    status: 'active',
    avatar: 'https://via.placeholder.com/150/DDA0DD/000000?text=RJ',
    address: '369 Electronic City, Bangalore, Karnataka 560100',
    gender: 'Male',
  ...
  },
  {
    ...
    parent: 'Ravi Menon',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/98D8C8/000000?text=DM',
    address: '741 Malleshwaram, Bangalore, Karnataka 560003',
    gender: 'Female',
  ...
  },
  {
    ...
    parent: 'Manoj Verma',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/F7DC6F/000000?text=AV',
    address: '852 Banashankari, Bangalore, Karnataka 560070',
    gender: 'Male',
    dateOfBirth: '2001-10-25',
    studentType: 'Migrated Student',
    previousSchoolName: 'Mount Carmel College',
    previousSchoolAddress: 'Palace Road, Bangalore, Karnataka 560052',
    previousSchoolStartDate: '2019-06-15',
    previousSchoolEndDate: '2021-05-20',
    documents: [
      { name: 'Transfer Certificate.pdf', url: 'http://example.com/docs/tc_aditya.pdf' },
      { name: 'Character Certificate.pdf', url: 'http://example.com/docs/cc_aditya.pdf' }
    ],
  },
  {
    id: 's12',
    admissionNo: 'ADM-2024-012',
    studentId: 'COM2024012',
    password: 'student123',
    name: 'Kavya Rao',
    rollNumber: 'COM24012',
    program: 'Commerce',
    ...
    parent: 'Srinivas Rao',
    status: 'active',
    avatar: 'https://via.placeholder.com/150/BB8FCE/FFFFFF?text=KR',
    address: '963 RT Nagar, Bangalore, Karnataka 560032',
    gender: 'Female',
      ...
      {/* Main Content */}
        ...
        {showFilters && (
          <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200 animate-fade-in grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label htmlFor="class-filter" className="block text-sm font-medium text-gray-700 mb-1">Program</label>
              <Select
                id="class-filter"
                ...
                filteredStudents.map((student) => (
                  <tr key={student.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                      {student.program} {student.semester && `(${student.semester})`}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                      {student.rollNumber}
                    </td>

...
const AttendanceModule = () => {
  ...
  let studentTableColumns = [
    ...
    { header: 'Program', accessor: 'program', className: 'px-4 py-3 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider' },
    { header: 'Semester', accessor: 'semester', className: 'px-4 py-3 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider' },
    ...
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-start items-center gap-4 md:gap-8 mb-6">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {activeTab === 'students' && (
              <>
                <label htmlFor="attendance-program" className="font-semibold text-gray-700 ml-4">Program:</label>
                <select
                ...
                <label htmlFor="attendance-semester" className="font-semibold text-gray-700 ml-4">Semester:</label>
                <select

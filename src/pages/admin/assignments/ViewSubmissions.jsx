...
const ViewSubmissions = ({ onBackToAssignmentModule, selectedProgramFilter, allAvailablePrograms }) => {
  ...
  const [mockAllSubmissions, setMockAllSubmissions] = useState([
    { submissionId: 101, assignmentTitle: "Data Structures Lab 3", program: "B.Com Computer Science", semester: "Semester 3", course: "Data Structures & Algorithms", studentName: "John Doe", submittedDate: "2025-09-19", status: "Graded", grade: "A", feedback: "Excellent work, very clear implementation.", file: { name: "john_doe_ds_lab3.pdf", content: "PDF content for Data Structures Lab 3 by John Doe." } },
    { submissionId: 102, assignmentTitle: "Data Structures Lab 3", program: "B.Com Computer Science", semester: "Semester 3", course: "Data Structures & Algorithms", studentName: "Jane Smith", submittedDate: "2025-09-20", status: "Pending", grade: "-", feedback: "", file: { name: "jane_smith_ds_lab3.docx", content: "DOCX content for Data Structures Lab 3 by Jane Smith." } },
    { submissionId: 103, assignmentTitle: "Thermodynamics Problem Set", program: "B.Sc. Physics", semester: "Semester 5", course: "Thermodynamics", studentName: "Alice Johnson", submittedDate: "2025-09-24", status: "Graded", grade: "B+", feedback: "Good effort, but review the calculations for accuracy.", file: { name: "alice_thermo_problems.pdf", content: "PDF content for Thermodynamics Problem Set by Alice Johnson." } },
    { submissionId: 104, assignmentTitle: "Modern European History Essay", program: "B.A. History", semester: "Semester 1", course: "Modern European History", studentName: "Bob Williams", submittedDate: "2025-09-23", status: "Late", grade: "C", feedback: "Submitted late. Content needs more detail.", file: { name: "bob_history_essay.docx", content: "DOCX content for Modern European History Essay by Bob Williams." } },
    { submissionId: 105, assignmentTitle: "Calculus II Assignment", program: "B.Com Computer Science", semester: "Semester 2", course: "Calculus II", studentName: "Eva Green", submittedDate: "2025-09-28", status: "Pending", grade: "-", feedback: "", file: { name: "eva_calculus2.pdf", content: "PDF content for Calculus II Assignment by Eva Green." } },
    { submissionId: 106, assignmentTitle: "Data Structures Lab 3", program: "B.Com Computer Science", semester: "Semester 3", course: "Data Structures & Algorithms", studentName: "David Lee", submittedDate: "2025-09-18", status: "Graded", grade: "B", feedback: "Solid understanding, minor errors in question 5.", file: { name: "david_ds_lab3.pdf", content: "PDF content for Data Structures Lab 3 by David Lee." } },
    { submissionId: 107, assignmentTitle: "Thermodynamics Problem Set", program: "B.Sc. Physics", semester: "Semester 5", course: "Thermodynamics", studentName: "Frank White", submittedDate: "2025-09-22", status: "Pending", grade: "-", feedback: "", file: { name: "frank_thermo.zip", content: "ZIP content for Thermodynamics Problem Set by Frank White." } },
  ]);
  ...
  const availablePrograms = allAvailablePrograms || ["All", "B.Tech Computer Science", "B.A. History", "B.Sc. Physics"];
  ...
  return (
    <div className="px-0 sm:px-2 md:px-4 lg:p-6 flex flex-col gap-2 sm:gap-4 lg:gap-8">
      ...
      <div className="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div>
          <label htmlFor="programFilter" className="block text-sm font-medium text-gray-700 mb-1">Filter by Program:</label>
          <div className="relative">
            <select
              id="programFilter"
              value={filterProgram}
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p><strong>Semester:</strong> {selectedSubmission.semester}</p>

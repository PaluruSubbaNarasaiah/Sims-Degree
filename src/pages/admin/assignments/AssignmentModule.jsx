    ...
    <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          {/* Program */}
          <div>
            <label htmlFor="edit-program" className="block text-sm font-medium text-gray-700 mb-1">Program <span className="text-red-500">*</span></label>
            <select
              id="edit-program"
              name="program"
          ...
          {/* Semester */}
          <div>
            <label htmlFor="edit-semester" className="block text-sm font-medium text-gray-700 mb-1">Semester <span className="text-red-500">*</span></label>
            <select
              id="edit-semester"
              name="semester"
...
const AssignmentModule = () => {
  ...
  const initialAssignmentsData = [
    { id: 5, title: "Data Structures Lab 3", program: "B.Com Computer Science", semester: 3, course: "Data Structures & Algorithms", dueDate: "2025-09-20", description: "Implement a binary search tree with insertion, deletion, and traversal methods." },
    { id: 6, title: "Modern European History Essay", program: "B.A. History", semester: 1, course: "Modern European History", dueDate: "2025-09-22", description: "Write a 2000-word essay on the causes of the French Revolution." },
    { id: 7, title: "Thermodynamics Problem Set", program: "B.Sc. Physics", semester: 5, course: "Thermodynamics", dueDate: "2025-09-25", description: "Solve problems from Chapter 3 of the textbook on the laws of thermodynamics." },
    { id: 8, title: "Financial Accounting Case Study", program: "B.Com", semester: 3, course: "Financial Accounting", dueDate: "2025-09-18", description: "Analyze the financial statements of a publicly listed company." },
    { id: 9, title: "Calculus II Assignment", program: "B.Com Computer Science", semester: 2, course: "Calculus II", dueDate: "2025-10-01", description: "Solve the provided set of problems on integration and differential equations." },
  ];
  ...
  return (
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="col-span-1 md:col-span-1 flex flex-col gap-4"> {/* Container for filters */}
            ...
            {/* Semester Filter */}
            <div>
              <label htmlFor="semesterFilter" className="block text-sm font-medium text-gray-700 mb-1">Filter by Semester:</label>
              <div className="relative">
                <select
                  id="semesterFilter"
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium text-gray-700">Program</h3>

          ...
          <div className="bg-white rounded-xl p-6 md:p-8 w-full max-w-lg md:max-w-xl shadow-2xl border border-gray-100 transition-all duration-300 ease-in-out transform scale-100 opacity-100">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-5">
                <div>
                  <label htmlFor="programName" className="block text-sm font-medium text-gray-700 mb-1">Program Name <span className="text-red-500">*</span></label>
                  <input
                    type="text"
                    id="programName"
                  ...
                  >
                    {submitting ? (
                      ...
                      <>
                        ...
                        {editingProgramId ? 'Save Changes' : (addedSemesters.length > 0 ? 'Done Adding' : 'Add Program')}
                      </>
                    )}
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-indigo-50 p-5 rounded-lg shadow-sm border border-indigo-100">
                  <h3 className="font-semibold text-lg mb-3 text-gray-800 flex items-center">
                    <Info size={22} className="mr-2 text-indigo-600" /> Program Information
                  </h3>
                  <div className="space-y-2 text-gray-700">
                    <p><span className="font-medium">Program:</span> {selectedProgram.programName}</p>
                ...
                <div className="bg-purple-50 p-5 rounded-lg shadow-sm border border-purple-100">
                  <h3 className="font-semibold text-lg mb-3 text-gray-800 flex items-center">
                    <Users size={22} className="mr-2 text-purple-600" /> Program Statistics
                  </h3>
                  <div className="space-y-2 text-gray-700">
                    <p><span className="font-medium">Enrolled Students:</span> {studentCounts[`${selectedProgram.programName}-${selectedProgram.semester}`] || 0}</p>
                  </div>
                </div>
              </div>
